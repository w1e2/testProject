  ...
  <div>
    <el-main>
      ...
      <el-table :data="selfList" style="width: 100%" class='table-common' :highlight-current-row="true" border v-if="isShowSingle">
        ...
        <el-table-column prop="missionprop1" label="管理机构" min-width="15%" align="center"></el-table-column>
        <el-table-column prop="missionprop3" label="录入日期" min-width="15%" align="center"></el-table-column>
        <el-table-column prop="missionprop3" label="操作员编码" min-width="15%" align="center"></el-table-column>
        <el-table-column prop="missionprop3" label="操作员姓名" min-width="15%" align="center"></el-table-column>
